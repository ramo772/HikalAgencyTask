...
abstract class Repository implements RepositoryInterface
{
    ...
    //                 $this->updateTranslations($model, $attribute, $data[$attribute]);
    //                 // dd($data[$attribute]);
     ...
     * @return Model|AppModel|null
     */
    public function findWith($id, array $columns = ['*'], array $relations = [])
    {
        return $this->model->with($relations)->find($id, $columns);
    }
    public function findAllWith(array $columns = ['*'], array $relations)
    {
